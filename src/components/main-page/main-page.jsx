  ...
  return (
    <div classNameName="page-content">
      <section classNameName="catalog">
        <h2 classNameName="catalog__title visually-hidden">Catalog</h2>

        <ul classNameName="catalog__genres-list">
          <li classNameName="catalog__genres-item catalog__genres-item--active">
            <a href="#" classNameName="catalog__genres-link">All genres</a>
          </li>
          <li classNameName="catalog__genres-item">
            <a href="#" classNameName="catalog__genres-link">Comedies</a>
          </li>
          <li classNameName="catalog__genres-item">
            <a href="#" classNameName="catalog__genres-link">Crime</a>
          </li>
          <li classNameName="catalog__genres-item">
            <a href="#" classNameName="catalog__genres-link">Documentary</a>
          </li>
          <li classNameName="catalog__genres-item">
            <a href="#" classNameName="catalog__genres-link">Dramas</a>
          </li>
          <li classNameName="catalog__genres-item">
            <a href="#" classNameName="catalog__genres-link">Horror</a>
          </li>
          <li classNameName="catalog__genres-item">
            <a href="#" classNameName="catalog__genres-link">Kids & Family</a>
          </li>
          <li classNameName="catalog__genres-item">
            <a href="#" classNameName="catalog__genres-link">Romance</a>
          </li>
          <li classNameName="catalog__genres-item">
            <a href="#" classNameName="catalog__genres-link">Sci-Fi</a>
          </li>
